    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-indigo-100/90 shadow-xs">
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-20">
          ...
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-tr from-indigo-600 via-blue-600 to-orange-500 rounded-xl flex items-center justify-center text-white shadow-sm shadow-indigo-600/30 group-hover:scale-105 transition-transform">
              <Flame className="w-5 h-5 sm:w-6 sm:h-6 text-white fill-amber-300" />
            </div>
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="font-updock font-bold text-indigo-950 text-2xl sm:text-3xl leading-none">
                  Tarunodaya
                </span>
                <span className="text-[9px] sm:text-[10px] uppercase tracking-widest font-black bg-indigo-100 text-indigo-900 border border-indigo-200 px-1.5 sm:px-2 py-0.5 rounded-md">
                  2026
                </span>
              </div>
          ...
          <nav className="flex items-center gap-1 sm:gap-3 text-[11px] sm:text-xs font-bold uppercase tracking-wider">
            <button
              ...
              className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1.5 sm:py-2.5 rounded-xl transition-all cursor-pointer ${
                activeTab === 'register'
                  ? 'bg-gradient-to-r from-indigo-600 to-blue-700 text-white shadow-md shadow-indigo-600/20'
            ...
            >
              ...
              {savedPassesCount > 0 && (
                <span className={`text-[9px] sm:text-[10px] font-black px-1.5 py-0.2 rounded-md ${
                  activeTab === 'passes' ? 'bg-orange-500 text-white' : 'bg-indigo-100 text-indigo-900'
                }`}>
                  {savedPassesCount}
                </span>
              )}
